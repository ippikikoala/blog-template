...
### 対応
- [ ] 元のHatenaブログエクスポートデータから内部リンクを抽出
- [ ] 現在のMDXファイルとの差分確認
- [ ] 内部リンク復元スクリプト作成
- [ ] リンク先のslugマッピング作成（Hatena URL → Next.js slug）
- [ ] 復元実行 & 動作確認

**優先度**: 中
**ファイル**:
- `content/posts/*.mdx` - 記事本文のリンク
...
### 対応
- [ ] 現在のスタイル定義を確認（`src/app/globals.css`）
- [ ] 見出しレベル別のフォントサイズ・太さを再設定
- [ ] Hatenaブログのスタイルと比較
- [ ] 複数記事で表示確認
...
- **完了**: 10/20
- **進行中**: 0/20
- **未着手**: 10/20（#10スマホUI改善, #12-19新規タスク, #20オプションタスク）
